...
public class Globals {
	...
	//고도화사업
    //파일 업로드 원 파일명
	public static final String NEW_ORIGIN_FILE_NM = "fileRealNm";
	//파일 확장자
	public static final String NEW_FILE_EXT = "fileEtsion";
	//파일크기
	public static final String NEW_FILE_SIZE = "fileSize";
	//업로드된 파일명
	public static final String NEW_UPLOAD_FILE_NM = "fileStoreNm";
	//파일경로
	public static final String NEW_FILE_PATH = "filePath";
	//파일구분코드
	public static final String NEW_FILE_DSTIN_CD = "fileDstinCd";
