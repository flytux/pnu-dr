 ...
 */
@Service("uniwellJhApplyService")
public class UniwellJhApplyServiceImpl extends CommonServiceImpl implements UniwellJhApplyService {
    @Autowired
    MessageSource localeMessageSource;

    @Autowired
    private UniwellJhApplyDao uniwellJhApplyDao;

    @Autowired
    private ComFunctionService comFunctionService;
    
    /**
     * 유니웰장학금신청 화면 신청기간 조회 한다.  관련된 정보를 DAO에서 호출하여 Controller에 Map으로 전달한다.
     * 
     * @param param
    ...
    public List<Map<String, Object>> selectListPriorityJhApplySchd(Map<String, Object> param) throws Exception {
        return uniwellJhApplyDao.selectListPriorityJhApplySchd(param);
    }

    /**
     * 유니웰장학금신청 화면 신청리스트 조회 한다.  관련된 정보를 DAO에서 호출하여 Controller에 Map으로 전달한다.
     * 
     * @param param
     * @return List<Map<String, Object>>
     * @throws Exception
    ...
    public List<Map<String, Object>> selectListPriorityJhApply(Map<String, Object> param) throws Exception {
        return uniwellJhApplyDao.selectListPriorityJhApply(param);
    }

    /**
     * 유니웰장학금신청 화면 학생정보 조회 한다.  관련된 정보를 DAO에서 호출하여 Controller에 Map으로 전달한다.
     * 
     * @param param
     * @return List<Map<String, Object>>
     * @throws Exception
    ...
    public List<Map<String, Object>> selectListStdtInfo(Map<String, Object> param) throws Exception {
        return uniwellJhApplyDao.selectListStdtInfo(param);
    }

    /**
     * 유니웰장학금신청 화면 계좌정보 조회 한다.  관련된 정보를 DAO에서 호출하여 Controller에 Map으로 전달한다.
     * 
     * @param param
     * @return List<Map<String, Object>>
     * @throws Exception
    ...
    public List<Map<String, Object>> selectListBank(Map<String, Object> param) throws Exception {
        return uniwellJhApplyDao.selectListBank(param);
    }

    /**
     * 유니웰장학금신청 화면 제출서류 조회 한다.  관련된 정보를 DAO에서 호출하여 Controller에 Map으로 전달한다.
     * 
     * @param param
     * @return List<Map<String, Object>>
     * @throws Exception
    ...
    public List<Map<String, Object>> selectListDocs(Map<String, Object> param) throws Exception {
        return uniwellJhApplyDao.selectListDocs(param);
    }

    /**
     * 유니웰장학금신청 화면 신청내역 조회 한다.  관련된 정보를 DAO에서 호출하여 Controller에 Map으로 전달한다.
     * 
     * @param param
     * @return List<Map<String, Object>>
     * @throws Exception
    ...
    public List<Map<String, Object>> selectListPriorityJhApplySearch(Map<String, Object> param) throws Exception {
        return uniwellJhApplyDao.selectListPriorityJhApplySearch(param);
    }
    ...
    public Map<String, Object> executePriorityJhApply(Map<String, Object> param) throws Exception {
    	...
    	if(agreeDltInfo != null && agreeDltInfo.size() > 0) {
    		...
    		if(result != null && "Y".equals(result.get("RESULT_YN")) ) { 
    	    	...
    	    	Map<String, Object> applyRtnMap = uniwellJhApplyDao.executePriorityJhApply(param);
    ...
    public Map<String, Object> deletePriorityJhApply(Map<String, Object> param) throws Exception {
    	...
    	rtnMap =uniwellJhApplyDao.deletePriorityJhApply(param);
    ...
    /**
     * 유니웰장학금신청 화면 형제/자매 조회 한다.  관련된 정보를 DAO에서 호출하여 Controller에 Map으로 전달한다.
     * 
     * @param param
     * @return List<Map<String, Object>>
     * @throws Exception
    ...
    public List<Map<String, Object>> selectListBrothers(Map<String, Object> param) throws Exception {
        return uniwellJhApplyDao.selectListBrothers(param);
    }
