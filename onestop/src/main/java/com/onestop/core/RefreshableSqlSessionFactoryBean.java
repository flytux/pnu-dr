...
/**
 * MyBatis로 작성 된 SLQ XML를 자동으로 Reroad 하는 클래스로서 작동한다.
 * @Copyright : sbcoba.tistory.com
 * @Author : 코바
 * @Create : 2012-08-18
 * @Title : RefreshableSqlSessionFactoryBean
 * @version 1.0
 * @stereotype Config
 */
                ...
                try {
                    ...
                    if (map.containsKey(resource)) {
                        ...
                        if (lastModified != modified) {
                            Long lng = new Long(modified);
                            map.put(resource, lng);
