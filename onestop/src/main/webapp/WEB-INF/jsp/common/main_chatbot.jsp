								...
								<div class="sec-body">
									<div class="logged-in-view">
										...
										<ul class="list list-logged">
											...
											<li><a href="javascript:openLinkSSO('bd','https://bd.pusan.ac.kr/rSSO/verify_process.php');"><i class="bi bi-bar-chart-fill" aria-hidden="true"></i> 학업성취분석</a></li>
											</c:if>
										</ul>
				...
				function() {
					...
					if (scwin.loginUser) {
						$(".logged-in-view .user-name")
								.text(scwin.loginUser.nm + " (" + scwin.loginUser.userId + ")");
