			...
			<div class="sec-body">
				...
				<div class="search-box">
					<div class="b-table-box flex-col-3" role="table" aria-label="조회">
						<div class="b-row-box" role="row">
							<div class="b-row-item">
								<div class="b-title-box" role="rowheader">
								    <label class="req" data-lang>시스템구분</label>
								</div>
								<div class="b-con-box" role="cell">
									<select id="SCH_SYSTEM_GCD" class="form-control"></select>
									<select id="SCH_NATION_NO_GCD" class="form-control"></select>
								</div>
							</div>
							<div class="b-row-item">
								<div class="b-title-box" role="rowheader">
								    <label data-lang>공통코드</label>
								</div>
								<div class="b-con-box" role="cell">
						...
						<div class="b-row-box" role="row">
                            <div class="b-row-item merge-3">
                                <div class="b-title-box" role="rowheader">
                                    <label data-lang>자동사이즈1</label>
                                </div>
                                <div class="b-con-box" role="cell" aria-colspan="5">
                                    <input id="AUTO_SIZING" class="form-control" auto-bind="SCH_COMMON_CD_KOR_NM" ></input>
                                </div>
                            </div>
                        </div>
                        <div class="b-row-box" role="row">
                            <div class="b-row-item">
                                <div class="b-title-box" role="rowheader">
                                    <label for="siteCheckEnymd" data-lang>캘린더1</label>
                                </div>
                                <div class="b-con-box" role="cell">
                                    <input type="text" id="siteCheckEnymd" name="siteCheckEnymd" class="form-control calendar" /><!-- 캘린더 : class에 datepicker추가 -->
                                </div>
                            </div>
                            <div class="b-row-item">
                                <div class="b-title-box" role="rowheader">
                                    <label data-lang>캘린더2</label>
                                </div>
                                <div class="b-con-box" role="cell">
                                	<input type="text" id="datetimepicker2" class="form-control datetimepicker2" /><!-- 캘린더 : class에 datepicker추가 -->
                                </div>
                            </div>
                            <div class="b-row-item">
                                <div class="b-title-box" role="rowheader">
						...
						<div class="b-row-box" role="row">                            
                            <div class="b-row-item">
                                ...
                                <div class="b-con-box" role="cell">
                                    <input type="text" id="profSearch" name="profSearch" class="form-control profsearcher" callbackFunc="profsearcherCallback" /><!-- 교원검색 : class에 profseacher추가 -->
                                </div>
                            </div>
                            <div class="b-row-item">
                                <div class="b-title-box" role="rowheader">
                                    <label data-lang>Slider</label>
                                </div>
                                <div class="b-con-box" role="cell">
                            ...
                            <div class="b-row-item">
                                ...
                                <div class="b-con-box" role="cell"></div>
                            </div>
                        </div>
                        <div class="b-row-box" role="row">
                            <div class="b-row-item">
                                <div class="b-title-box" role="rowheader">
                                    <label data-lang>상위구분코드(linked)</label>
                                </div>
                                <div class="b-con-box" role="cell">
                                    <!-- <select id="LINK_UPPER_GCD" class="form-control"></select> -->
                                    <select id="LINK_UPPER_GCD" class="form-control" style="width:200px"></select>
                                </div>
                            </div>
                            <div class="b-row-item">
                                <div class="b-title-box" role="rowheader">
                                    <label data-lang>구분코드(linked)</label>
                                </div>
                                <div class="b-con-box" role="cell">
                                    <select id="LINK_MIDDLE_GCD" class="form-control"></select>
                                </div>
                            </div>
                            <div class="b-row-item">
                                <div class="b-title-box" role="rowheader">
                                    <label>세부구분코드(linked)</label>
                                </div>
                                <div class="b-con-box" role="cell">
									<select id="LINK_LOWER_GCD" class="form-control"></select>
                                </div>
                            </div>
                        </div>
                        <div class="b-row-box" role="row">
                            <div class="b-row-item">
                                <div class="b-title-box" role="rowheader">
                                    <label data-lang>AutoComplete</label>
                                </div>
                                <div class="b-con-box" role="cell">
                            ...
                            <div class="b-row-item merge-2">
                                <div class="b-title-box" role="rowheader">
                                    <label class="req" data-lang>멀티셀렉트</label>
                                </div>
                        ...
                        <div class="b-row-box" role="row">
                        	<div class="b-row-item merge-3">
                                <div class="b-title-box" role="rowheader">
                                    <label data-lang>STDT_GCD</label>
                                </div>
                                <div class="b-con-box" role="cell">
                                    <div id="STDT_GCD"  ></div>
                                </div>
					...
					<div class="btn-box">
						<div class="form-row">
							<div class="col-auto">
								<button class="btn btn-danger" type="button" onclick="javascript:return fn_clause();" data-lang>약관동의</button>
                                <button class="btn search-btn" type="button" onclick="javascript:return fn_sch();" data-lang>조회</button>
                                <button class="btn btn-icon print-btn" type="button" onclick="javascript:return fn_add();" data-lang>신규</button>
							</div>
						</div>
					</div>
				</div> 
                                ...
                                <div id="doc" style="display:none;">
									<li>
									    ...
									    <ul>
									        ...
									        <li>hakbuGradFg : 접속한 학생의 소속이 학부인지 대학원인지에 따라 공통코드의 '학부사용여부','대학원사용여부'에 해당하는 데이터만 가지고 올지 정의(생략가능) - 기본은 true</li>
									        <li>dataBound : dropdownlist 적용 후 처리해야 할 작업을 정의 (생략가능)</li>
						                    <li>linkedTarget : linked Combo의 target이 되는 엘리먼트(select)</li>
						                    <li>linkedInfo.targetColumn : linked Combo의 target이 되는 엘리먼트(select)의 column</li>
						                    <li>linkedInfo.column : linked Combo의 target이 되는 엘리먼트(select)의 column과 매칭이 되는 column</li>
									    </ul> 
									</li>
									<li>
	                                ...
	                                <li>
	                                    ...
	                                    <ul>
											...
											<li>position : window화면을 기준으로 팝업을 표시할 위치 지정 (미 입력시 중앙정렬)</li>
											...
											<li>scrolling : (on) 팝업창을 호출하면 자동으로 최상단으로 이동, (off) 팝업 호출 시 스크롤이동 없음 (기본값:off)</li>
											<li>scroll : (on) 팝업창 호출 시 메인화면의 전체 스크롤 보여짐, (off) 팝업창 호출 시 메인화면의 전체 스크롤 없애기 (기본값:on)</li>
	                                ...
	                                <li>
	                                    <span class="dfn">06) </span>gfn_com_assignCombo (공통소속콤보)
	                                    <ul>
	                                        <li>collGradGcd : 대학/대학원 엘리먼트</li>
	                                        <li>gradGcd : 대학원 엘리먼트</li>
	                                        <li>collCd : 단과대학 엘리먼트</li>
	                                        <li>deptCd : 학과(부) 엘리먼트</li>
	                                        <li>majorCd : 전공 엘리먼트</li>
	                                        <li>gradGcdExtUrl : 대학원 데이터를 가지고 오는 별도 url정의</li>
								        	<li>collCdExtUrl :  단과대학 데이터를 가지고 오는 별도 url정의</li>
								        	<li>deptCdExtUrl :  학과(부) 데이터를 가지고 오는 별도 url정의</li>
								        	<li>majorCdExtUrl :  전공 데이터를 가지고 오는 별도 url정의</li>
								        	<li>comboLvl : 5
								        	<li>initChk : 로그인한 사용자의 소속정보를 화면로딩시 보여줄지 여부 - (기본값:true) </li>
	                                        <li>comboLvl : 콤보레벨</li>
	                                        <li>dataBound : 콤보바인딩 callback함수정의</li>
	                                    </ul>
	                                </li>
	                            </div>
							</ul>
...
<script type="text/javascript">
	...
	function fn_initScreen() {		
		...
		$("#USER_GCD").RadioList({      
			 SYSTEM_GCD : "0000",
			 CODE : "USER_GCD",
			 QPARAM : " AND COMMON_DETAIL_CD ='0001' ",  // 옵션 생략가능
			 ALL_STR : "전체",												  // 옵션 생략가능
			 defaultValue : "0001",										  // 옵션 생략가능
		...
		gfn_com_createDateTimeComp2("datetimepicker2",calendar_date);
		/* $('#id_0').datetimepicker({
		...
		gfn_com_DropDownLists([{          
            ...
            hakbuGradFg : false,
            dataBound : function(e) {
				$("#SCH_SYSTEM_GCD").bind("change",function(){
					gfn_com_assignCombo({
				       	...
				       	,gradGcdExtUrl : {
				       		url:"/core/function/getAssignComboGradGcdInfo",
				       		param:{
				       			aaa : $("#SCH_SYSTEM_GCD").val(),
				       			bbb : '...'
				       		}
				       	}
				       	,collCdExtUrl : ""
		...
		*/  
		...
		$("#LINK_UPPER_GCD").dropDownList({          
			dataSource : null,
            commonCode : "0000_USER_GBN_UPPER_PART_GCD",
            dataTextField : "COMMON_DETAIL_CD_KOR_NM",
            dataValueField : "COMMON_DETAIL_CD",
            optionLabel : "선택",
            optionValue : "",
            ...
            hakbuGradFg : false,
            dataBound : function(e) {
            	$("#LINK_MIDDLE_GCD").dropDownList({          
        			dataSource : null,
                    commonCode : "0000_USER_GBN_MIDDLE_PART_GCD",
                    dataTextField : "COMMON_DETAIL_CD_KOR_NM",
                    dataValueField : "COMMON_DETAIL_CD",
                    optionLabel : "선택",
                    optionValue : "",
                    expnCondition : "",
                    hakbuGradFg : false,
                    linkedTarget : $("#LINK_UPPER_GCD"),
                    linkedInfo : [{                    	
                        targetColumn : 'COMMON_DETAIL_CD',
                        column : 'CHAR_1_CONTENT'
                    }],
                    dataBound : function(e) {
                    	$("#LINK_LOWER_GCD").dropDownList({          
                			dataSource : null,
                            commonCode : "0000_USER_GBN_LOWER_PART_GCD",
                            dataTextField : "COMMON_DETAIL_CD_KOR_NM",
                            dataValueField : "COMMON_DETAIL_CD",
                            optionLabel : "선택",
                            optionValue : "",
                            expnCondition : "",
                            hakbuGradFg : false,
                            linkedTarget : $("#LINK_MIDDLE_GCD"),
                            linkedInfo : [{
                                targetColumn : 'CHAR_1_CONTENT',
                                column : 'CHAR_1_CONTENT'
                            },{
                                targetColumn : 'COMMON_DETAIL_CD',
                                column : 'CHAR_2_CONTENT'
                            }],
                            dataBound : function(e) {
        ...
        */
		...
		2) 여러콤보에 값을 세팅할때는 대학/대학원 부터 차례대로 콜백을 이용해서 처리
		$("#SCH_COLL_GRAD_GCD").setValue("0001",function(){
			$("#SCH_GRAD_GCD").setValue("0000",function(){
				$("#SCH_COLL_CD").setValue("310000");
			});
		});
		3) disable or readonly 처리
		$("#SCH_COLL_GRAD_GCD").setReadOnly(true); --> true:현재선택된값만 선택가능
        */		
		...
		gfn_ajax_request({
            ...
            success : function(data, responseData) {            	
            	$("#resultTbody2").listView({
                    ...
                    /* emptyComment : '데이터가 없어요~!!!', */
                    dataBound : function(e) {
                    	$("#resultTbody2 tr").find("td:not(:last)").bind("click", function(e) {
                            scwin.detailObj = $(this).closest("tr").data();  
                            scwin.rowState = 'U';
                            fn_openPopup({
                            	filename : 'samplePop',
	...
	function fn_clause() {
		...
		gfn_com_clausePop({
			...
			clauseSeqNo : 1, /* 공통.약관관리(SYS_CLAUSE_MNG) 테이블의 약관순번(CLAUSE_SEQ_NO) */
			params : { /*  ${syearTerm}로 입력 된 문자열에 대해 치환할 값을 정의 */
				syearTerm : "2022-01-01",
				eyearTerm : "2022-12-31"
			},
	...
	function profsearcherCallback(e) {
		console.log(e);
	}
</script>