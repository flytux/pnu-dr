	...
	<div class="header-sub">
		<div class="container">
			<ul class="list list-with-separator">
				...
				-->
				<li><a href="https://international.pusan.ac.kr/" title="새창열림" target="_blank">PNU International</a></li>
				<li id="divNowIp" style="display:none" ><a href="#divNowIp" onclick="reSession();return false;" title="접속IP,클릭시 세션시간갱신"><span>127.0.0.1</span></a></li>
				<li id="divFinalLogin" style="display:none" ><a href="#divFinalLogin" onclick="reSession();return false;" title="최종접속일자,클릭시 세션시간갱신"><span>2000-01-01</span></a></li>
				...
				<a href="#global_login" onclick="ssoOpen();return false;" onkeypress="this.onclick;" data-lang>
				</c:when>
				<c:otherwise>
				<a href="/main">
				</c:otherwise>
		...
		<div class="container">
			<div class="header-item">
				<h1 tabindex="0" class="heading" onclick="javascript:location.href='/main'">
					<img class="logo" src="/common/images/logo.svg" alt="부산대학교">
					<div class="title-box">
	...
	<script type="text/javascript" language="javascript">
		$(document)
				.ready(
						function() {
							/*
							if(scwin.loginUser.originId == "515329" || scwin.loginUser.userId == "515329"){
								$(".mUrl").text(scwin.menuInfo.URL_CONTENT);
							}
							*/
							if (!gfn_com_isEmptyObject(scwin.loginUser)) {
								...
								var ckNowIp = $('#divNowIp a span');
								var ckFinalLogin = $('#divFinalLogin a span');
								var finalLoginDt = moment(scwin.loginUser.finalLoginDt).format("YYYY-MM-DD HH:mm:ss");
								
								ckNowIp.html("접속IP:"+scwin.loginUser.userIp);
								ckFinalLogin.html("최종 접속시간:"+finalLoginDt);
			...
			for ( var menu1 in menu1Depth) {
				if (menu1Depth[menu1].EXT_PERMIT_FG == 'Y') {
					...
					if(menu1Depth[menu1].MENU_CONTENT_GCD =="0004"){
					    menuItem += '<a href="'+menu1Depth[menu1].MENU_VAR_INFO+'" target="_blank"  title="새창열림" data-haspopup="true" data-expanded="false">'
							...
							if (menu2Depth[menu2].MENU_GCD == '0002') {
								if(i==0){
									...
									if(menu2Depth[menu2].MENU_CONTENT_GCD =="0004"){
									    menuItem += '<a  id="'+menu2Depth[menu2].MENU_CD+'" href="'+menu2Depth[menu2].MENU_VAR_INFO+'" target="_blank" title="새창열림" '
								    ...
								    if(menu2Depth[menu2].MENU_CONTENT_GCD =="0004"){
										menuItem += '<a   href="'+menu2Depth[menu2].MENU_VAR_INFO+'" target="_blank" title="새창열림"'
										+ ' data-haspopup="true" data-expanded="false">'
										+ langMenuNm(menu2Depth[menu2])
										+ '</a>';		
								    }else{
						...
						for ( var menu3 in menu3Depth) {
							if (menu3Depth[menu3].MENU_GCD == '0002') {
							    if(menu3Depth[menu3].MENU_CONTENT_GCD =="0004"){
							        menuItem += '<li ><a  id="'+menu2Depth[menu2].MENU_CD+'" href="'+menu3Depth[menu3].MENU_VAR_INFO+'" target="_blank" title="새창열림" >'
...
<div class="layer-popup s400 alert_popup" draggable="true">
	<div class="pop_header" >
		<img src="/common/images/ico_pop_monitor.png" alt="" /><span data-lang>알림</span>
		<a href="#" class="popup_close modal_alert_close" tabindex="0"><img src="/common/images/icon_pop_close.png" alt='레이어팝업닫기'></a>
	</div>
	<div class="pop_container">
		<div class="txt_dialog message"></div>
		<p class="foot_btn" data-lang>
			<a href="#header" class="btn_n bg_red modal_alert_confirm" data-lang>확인</a> <i class="linkEndAppend" tabindex="0"></i>
		</p>
	</div>
</div>
...
<div class="layer-popup s400 confirm_popup" draggable="true">
	<div class="pop_header">
		<img src="/common/images/ico_pop_monitor.png" alt=""/><span data-lang>확인</span> <a class="popup_close modal_alert_close" tabindex="0"><img src="/common/images/icon_pop_close.png" alt='레이어팝업닫기'></a>
	</div>
	<div class="pop_container">
		<div class="txt_dialog message"></div>
		<p class="foot_btn">
			<a href="#header" class="btn_n bg_red modal_alert_confirm" data-lang>확인</a> <a href="#" class="btn_n bg_gray modal_alert_close">취소</a> <i class="linkEndAppend" tabindex="0"></i>
		</p>
	</div>
</div>
<script type="text/javascript" language="javascript">
