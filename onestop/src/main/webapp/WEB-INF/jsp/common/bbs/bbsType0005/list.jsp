...
<script src="/common/js/gfn/gfn_bbs5.js"></script>
												...
												function(e) {
													...
													if(bbsData.SECRET_FG == 'Y' ){
														if(bbsMgrAuth.SECRET_POSTING_SEARCH_AUTH_FG == 'Y' 
															|| bbsData.INS_USER_ID.trim() == scwin.loginUser.userId){
															reqData.mode = "DETAIL";
															fn_openPopup({
																width : 1000,
													            height : 650,
