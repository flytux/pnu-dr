    ...
    <div class="page-main">
      <div class="page-box">
        ...
        <div class="page-inner">
          <div class="btn-list">
            <ul>
              <li><a href="https://onestop.pusan.ac.kr/login" class="btn btn-primary" target="_blank" title="학생지원시스템 바로가기">학생지원시스템 바로가기</a></li>        
            </ul>
          </div>        
        </div>
        <div class="page-inner">
          ...
          <div class="btn-list">
            <ul>
              <li><a href="https://sugang.pusan.ac.kr" class="btn btn-success" target="_blank" title="수강신청 바로가기"><strong>수강신청 바로가기</strong></a></li>
              <!-- 
        ...
        <div class="page-inner">
          ...
          <div class="btn-list-sub">
            <ul>
              <li><a href="https://onestop.pusan.ac.kr/page?menuCD=000000000000335" class="btn" target="_blank" title="수강편람">수강편람</a></li>
              <li><a href="https://onestop.pusan.ac.kr/page?menuCD=000000000000360" class="btn" target="_blank" title="타대생 수강편람">타대생 수강편람</a></li>
              <!-- 
