						...
						<div class="b-row-box" role="row">
							<div class="b-row-item">
								<div class="b-title-box" role="rowheader">
                                    <label class="req" for="SCH_SYEAR" data-lang>프로그램 선택</label>
                                </div>
				...
				<div class="col-md-12">
					...
					<div>
						<table class="table table_line table-bordered">
							<caption>신청학생 개인정보</caption>
							<thead>
								<tr>
									<td scope="colgroup" colspan="5" class="table_blue_tx">
							...
							<tbody>
								<tr>
									<th scope="rowgroup" class="table_box_background table_m table_w10" rowspan="2">성명(Name)<br>姓名</th>
									<th scope="row" class="table_box_background table_m table_w10">국문(Korean)<br>韩语</th>
									<td class="table_m" style="width:35%">&nbsp;<span id="lbl국문성명"></span></td>
									<th scope="row" class="table_box_background table_m table_w15" rowspan="2">국적(Nationality)<br>国籍</th>
									<td class="table_m table_w30" rowspan="2">&nbsp;<span id="lbl국적"></span></td>
								</tr>
								<tr>	
									<th scope="row" class="table_box_background table_m">영문(English)<br>英语</th>
									<td class="table_m">&nbsp;<span id="lbl영문성명"></span></td>
								</tr>
								<tr>
									<th scope="row" class="table_box_background table_m" colspan="2">이수과정(Study Program)<br>所属课程</th>
									<td class="table_m">&nbsp;<span id="lbl이수과정"></span></td>
									<th scope="row" class="table_box_background table_m">성별(Gender)<br>性别</th>
									<td class="table_m">&nbsp;<span id="lbl성별"></span></td>
								</tr>
								<tr>
									<th scope="row" class="table_box_background table_m" colspan="2">학과(Major)<br>所属专业</th>
									<td class="table_m">&nbsp;<span id="lbl학과"></span></td>
									<th scope="row" class="table_box_background table_m">학번(PNU ID)<br>学号</th>
									<td class="table_m">&nbsp;<span id="lbl학번"></span></td>
								</tr>
								<tr>
									<th scope="row" class="table_box_background table_m" colspan="2">휴대폰(Cellphone)<br>手机</th>
									<td class="table_m">&nbsp;<span id="lbl연락처"></span></td>
									<th scope="row" class="table_box_background table_m">이메일(Email)<br>电子邮件</th>
									<td class="table_m">&nbsp;<span id="lbl이메일"></span></td>
								</tr>
							</tbody>
						</table>
						<table class="table table_line table-bordered">
							<caption>참여 희망 프로그램</caption>
							<thead>
								<tr>
									<td scope="colgroup" colspan="4" class="table_blue_tx">◎ 참여 희망 프로그램 (Program to Apply)<br>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;希望参与的活动</td>
								</tr>
							</thead>
							<tbody>
								<tr>
									<th scope="row" class="table_box_background table_m table_w20">프로그램명칭<br>(Mentoring Title)<br>活动名称</th>
									<td class="table_m" style="text-align:left;" colspan="3">&nbsp;<span
										id="lbl프로그램명칭"></span></td>
								</tr>
								<tr>
									<th scope="row" class="table_box_background table_m table_w20">멘토소속(Position)<br>导师所属单位</th>
									<td class="table_m" style="width:35%">&nbsp;<span id="lbl멘토소속"></span></td>
									<th scope="row" class="table_box_background table_m table_w15">멘토성명(Name)<br>导师姓名</th>
						...
						<table class="table table_line">
							...
							<thead>
								<tr>
								<td scope="col" class="table_blue_tx">◎ &nbsp;<label for="chk1">프로그램 동의여부 (Confirm) 确认</label> &nbsp; 
						...
						<table class="table table_line">
							...
							<thead>
								<tr>
									<td scope="col" class="table_blue_tx">◎ &nbsp;<label for="chk2">개인정보 동의여부 (Agree) 同意</label> &nbsp; 
				...
				<div class="col-md-12">
					...
					<div>
						<table class="table table_line table-bordered">
							...
							<thead>
								<tr>
									<td scope="colgroup" colspan="5" class="table_blue_tx">◎ 본인 정보 확인 (Confirm Personal Information)<br>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;确认本人信息</td>
								</tr>
							</thead>
							<tbody>
						...
						<table class="table table_line table-bordered">
							...
							<thead>
								<tr>
									<td scope="colgroup" colspan="4" class="table_blue_tx">◎ 신청내역 확인 (Confirm Application)<br>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;确认申请内容
									</td>
								</tr>
							</thead>
...
<script type="text/javascript">
	...
	function memberChk(){
        ...
        gfn_ajax_request({
            url : "/ost/mento/mentoring/mentoringInfoChkForeign",
            reqData : data,
	...
	function ProgramList() {
        ...
        gfn_ajax_request({
            url : "/ost/mento/mentoring/mentoringSearchForeign",
            reqData : data,
            success : function(data, responseData) {
	...
	function ProgramListDetail(paramMap) {		
		gfn_ajax_request({
            url : "/ost/mento/mentoring/mentoringDetailSearchForeign",
            reqData : data,
            success : function(data, responseData) {
            	var datas=data;
	...
	function btnClick(){
        ...
        gfn_ajax_request({
            url : "/ost/mento/mentoring/applyInsertForeign",
            reqData : data,
            success : function(data, responseData) {
	...
	function applySearch(){
        ...
        gfn_ajax_request({
            url : "/ost/mento/mentoring/applySearchForeign",
            reqData : data,
            success : function(data, responseData) {
	...
	function btnDel(){
		...
		confirm("신청취소하시겠습니까?",function(_flag){
        	if(_flag){
                gfn_ajax_request({
                    url : "/ost/mento/mentoring/applyDeleteForeign",
                    reqData : data,
                    success : function(data, responseData) {
