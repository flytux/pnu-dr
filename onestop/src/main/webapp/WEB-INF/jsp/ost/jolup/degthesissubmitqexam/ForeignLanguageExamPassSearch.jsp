	...
	<main id="main">
		<section class="sec-1">
			...
			<!-- 바디 영역 -->			
				...
				<section class="sec-2">
					<header>
						<h4 class="sec-title">학위논문제출자격시험 : 외국어시험 결과조회</h4>
					</header>
					<div class="table-box" id="grid01"style="height:300px;">
						<div class="table-body">
							...
							<caption>학위청구시험의 외국어시험 합격조회</caption>
							<thead>
								<tr>
...
<script type="text/javascript">
	 ...
	 * 조회
	 **************************************************************************/
	 const ajaxPath = '/ost/jolup/degthesissubmitqexam/foreignlanguageexampasssearch' 
