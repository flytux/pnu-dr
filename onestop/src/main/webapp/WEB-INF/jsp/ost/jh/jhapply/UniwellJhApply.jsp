...
<script type="text/javascript">
	...
	***************************************************************************************************/
	function fn_sch(data){
		if (gfn_com_isEmptyObject(data)) {
			data = {"JH_APPLY_GCD" : '0040' };
		}
		gfn_ajax_request({
			url : "/ost/jh/jhapply/UniwellJhApply/selectListPriorityJhApplySchd",
			reqData : data,
	...
	***************************************************************************************************/
	function fn_applySch() {
		 ...
		 /* ajax처리 */
		gfn_ajax_request({
			url : "/ost/jh/jhapply/UniwellJhApply/selectListPriorityJhApply",
			reqData : searchParam,
			success : function(data, responseData) {
	...
	***************************************************************************************************/
	function fn_openPopup(param) {
		...
		gfn_com_modalPopup({
			...
			target : null,
			title : "유니웰장학금신청",
			include : "/html/ost/jh/jhapply/UniwellJhApplyPop.html"
		});
	}
