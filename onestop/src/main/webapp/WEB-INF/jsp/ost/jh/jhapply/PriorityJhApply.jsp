					...
					<div class="sec-body">
						...
						<div class="btn-box " id="BTN_BOX">
							<div class="form-row align-items-center btn-box-right">
								<div class="col-auto ">
									<p class="info-text info-text-style-2">'접수불가' 처리시, 신청서 삭제 후 다시 신청가능합니다. </p>
								</div>
								<div class="col-auto">
...
<script type="text/javascript">
	...
	***************************************************************************************************/
	function fn_sch(data){
		if (gfn_com_isEmptyObject(data)) {
			data = {"JH_APPLY_GCD" : '0010' };
		}
		gfn_ajax_request({
			url : "/ost/jh/jhapply/PriorityJhApply/selectListPriorityJhApplySchd",
			reqData : data,
	...
	***************************************************************************************************/
	function fn_applySch() {
		 ...
		 /* ajax처리 */
		gfn_ajax_request({
			url : "/ost/jh/jhapply/PriorityJhApply/selectListPriorityJhApply",
			reqData : searchParam,
			success : function(data, responseData) {
	...
	***************************************************************************************************/
	function fn_openPopup(param) {
		...
		gfn_com_modalPopup({
			...
			target : null,
			title : "우선선발장학금신청",
			include : "/html/ost/jh/jhapply/PriorityJhApplyPop.html"
		});
	}
